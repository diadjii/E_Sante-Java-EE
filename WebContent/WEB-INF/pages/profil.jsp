				...
				<form>
					<div class="form-group">
						<div class="row">
							<div class=" col-4 offset-md-2 form-group">
								<label for="nom">Nom</label> <input id="nom "
									...
									value="${patient['nom']}" min="3" /> <span class="text-danger">
							...
							<div class=" col-4 offset-md-2 form-group">
								<label>Prenom</label> <input class="form-control" type="text"
									name="prenom" value="${patient['prenom']}" /> <span
						...
						<div class="row">
							<div class="col-4 offset-md-2 form-group">
								<label>Login</label> <input class="form-control" type="text"
									name="login" value="${patient['login']}" /> <span
									class="text-danger"> <c:out
							...
							<div class="col-4  offset-md-2 form-group">
								<label>Nouveau mot de passe</label> <input class="form-control"
									name="oldpassword" value="${patient['mdp']}" hidden /> <input
						...
						<div class="row">
							...
							<div class="col-4 offset-md-2 form-group">
								<label>Groupe Sanguin</label> <select name="groupe">
									<option>Selectionnez un Groupe</option>
									<option ${selectA} value="A">Groupe A</option>
									<option ${selectB} value="B">Groupe B</option>
									<option ${selectO} value="O">Groupe O</option>
						...
						<div class="row">
							<div class="col-4 offset-md-2 form-group">
								<label>Contact</label> <input class="form-control" type="tel"
									name="contact" value="${patient['contact']}" /> <span
									class="text-danger"> <c:out
							...
							<div class="col-4 offset-md-2 form-group">
								<label>Age</label> <input class="form-control" type="number"
									min=0 name="age" value="${patient['age']}" /> <span
									class="text-danger"> <c:out
										value="${error['erreurs']['age'] }"></c:out>
								</span>
							</div>
						</div>
						<input type="submit" id="editProfilP"
